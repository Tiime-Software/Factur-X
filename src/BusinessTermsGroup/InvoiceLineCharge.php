...
use Tiime\FacturX\DataType\ChargeReasonCode;
...
class InvoiceLineCharge
{
    ...
    public function setAmount(float $amount): InvoiceLineCharge
    {
        $this->amount = $amount;
    ...
    public function setBaseAmount(?float $baseAmount): InvoiceLineCharge
    {
    ...
    public function setPercentage(?float $percentage): InvoiceLineCharge
    {
    ...
    public function setReason(?string $reason): InvoiceLineCharge
    {
        $this->reason = $reason;
    ...
    public function setReasonCode(?ChargeReasonCode $reasonCode): InvoiceLineCharge
    {
